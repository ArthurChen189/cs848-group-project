TASK_NAME = "rossman_gpt2_dp_parent"
...
data = pandas.read_csv("/home/qfyan/projects-qfyan/privacy_data/datasets/preprocessed/rossmann/rossmann_parent.csv")
print(data.head())
...
great.save(f"/home/qfyan/projects-qfyan/privacy_checkpoints/{TASK_NAME}_parent_final")
